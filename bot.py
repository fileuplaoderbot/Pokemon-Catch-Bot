...
# Connect to MongoDB
client = pymongo.MongoClient('mongodb+srv://AniReal123:AniReal123@anireal123.wqnsp.mongodb.net/?retryWrites=true&w=majority&appName=AniReal123')
db = client['AniReal123']
...
def start(_, message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Join Channel", url="https://t.me/ShinchanDubber"),
                InlineKeyboardButton("Add me to a Group", url="https://t.me/AniReal_Pokemon_Bot?startgroup=true")
            ]
        ]
    )
